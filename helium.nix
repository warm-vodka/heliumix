...
let
  ...
  src = fetchurl {
    ...
    sha256 = {
      aarch64-linux = "sha256-aLLO4dKxZ0kgrtfDUkO2fQTj6PVS9hWW5WA70kab+3o=";
      x86_64-linux = "sha256-jF5qPYeCibruFqqH+0lhn6n2df5K31xVbaU7xh9BjoM=";
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    # Add WideVine DRM Support (optional, requires widevine-cdm)
    ${lib.optionalString (widevine-cdm != null) ''
